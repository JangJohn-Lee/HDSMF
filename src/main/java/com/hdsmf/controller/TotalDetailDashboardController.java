...
@Controller
@RequestMapping("/")
public class TotalDetailDashboardController {
    ...
    public TotalDetailDashboardController(CategoryService categoryService, RackDetailInfoService rackDetailInfoService, IOBoundService iOBoundService, RackInfoService rackInfoService, ComponentsService componentsService){
    ...
    @GetMapping("/hdsmf/totaldetaildashboard")
    public String rackInfo(Model model){
        ...
        return "pages/totaldetaildashboard/totaldetaildashboard";
    }
