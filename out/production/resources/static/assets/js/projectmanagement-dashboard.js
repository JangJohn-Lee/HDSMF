(function (factory) {
  ...
  // 적재 현황 파악
  const ioboundDiscoveredChartInit = () => {
    const { getColor, getData } = window.phoenix.utils;
    const issuesDiscoveredChartEl = document.querySelector('.echart-iobound-chart');
        ...
        series: [
          {
            ...
            data: [
              { value: iOAvailableCount, name: '적재가능' },
              { value: iOBoundCount, name: '적재중' }
            ]
          }
        ],
        grid: {
  ...
  //   const { getColor, getData } = window.phoenix.utils;
  //   const issuesDiscoveredChartEl = document.querySelector('.echart-category-chart');
  ...
  // 카테고리별 현황
  const categoryDiscoveredChartInit = () => {
    const { getColor, getData } = window.phoenix.utils;
    const issuesDiscoveredChartEl = document.querySelector('.echart-category-chart');
  ...
  docReady(ioboundDiscoveredChartInit);
  docReady(categoryDiscoveredChartInit);
